...
public class MainActivity extends Activity {
	...
	IEE_DataChannel_t[] Channel_list = {
			IEE_DataChannel_t.IED_AF3,
			IEE_DataChannel_t.IED_T7,
			IEE_DataChannel_t.IED_Pz,
			IEE_DataChannel_t.IED_T8,
			IEE_DataChannel_t.IED_AF4,
			IEE_DataChannel_t.IED_O2,
			IEE_DataChannel_t.IED_F7,
			IEE_DataChannel_t.IED_P8,
			IEE_DataChannel_t.IED_F3,
			IEE_DataChannel_t.IED_FC5,
			IEE_DataChannel_t.IED_FC6,
			IEE_DataChannel_t.IED_F4,
			IEE_DataChannel_t.IED_P7,
			IEE_DataChannel_t.IED_F8,
			IEE_DataChannel_t.IED_O1};
	String[] Name_Channel = {
			"AF3",
			"T7",
			"Pz",
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Grab buttons from UI and wire up handlers
...
//						if(isEnablGetData && isEnableWriteFile)handler.sendEmptyMessage(2);
						if(ConnectionManager.isConnected && isEnableWriteFile){
